...
([run.py:212](../src/vcb/run.py#L212)): `--naming-tag`, then `--file-tag`, then the
first 32 characters of the first input filename's stem. Since 2026-07-27 a
warning is printed when both are given.
